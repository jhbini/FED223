...
$(() => {
    ...
    *************************************************************/
    ...
    $(window).scroll(function () {
        ...
        // 스크롤 위치 기준은 100px 이상일때
        // 스크롤을 한번 작게 작동할 때 100px이동함
        if (scTop >= 100) {
            // 상단영역에 클래스 on주기
            topA.addClass("on");
        } //////////// if ////////////
        ...
        // forEach((val,idx)=>{}) 두번째 전달값 순번을 사용하므로
        // 전달변수를 2개 모두 써야함
    ...
    // 로딩테스트용 동영상 넣기
    // $("body").prepend('<iframe width="640" height="360" src="https://www.youtube.com/embed/FLNUcZxCT6k" title="[한산: 용의 출현] 티저 예고편" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
...
// Map() 객체 아레 메서드 :set(), get(), has(), delete()
