...
$(() => {
    ...
    /**************************************************************** 
        ...
        - 키보드 관련 이벤트 : ketpress, keyup,keydown
        1. keypress : 키가 눌렸을때
        2. keyup : 키가 눌렸다가 올라올때
        3. ketdown : 키가 눌려져서 내려가있을때
        -> 과연 글자가 입력되는 순간은 
           어떤 키보드 이벤트가 적용되는 걸까?
        ->>>>>>> keyup

        - 이벤트 대상 : #emali1, #email2
    ...
    ****************************************************************/
    ...
    /**************************************************************** 
        ...
        검사방법: 선택박스기존 이벤트 함수 blur 이벤트를 강제로 발생시킨다.
